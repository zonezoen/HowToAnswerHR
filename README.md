...
最近趁着有时间，把这个专题整理了一下，并新建了一个 github 仓库，欢迎持续关注。 
点击阅读原文可直达项目。
```
https://github.com/zonezoen/HowToAnswerHR
```
...
对于这个问题，第一首先要知道程序员等级、技能、工资的绑定情况，因为我们工程师主要是看技术。技术实力决定了我们的月薪；第二要打探出公司能给出的薪资范围。在这个范围内争取高薪资。
...
1. 北京的生活成本高，3000元在北京生存很艰难，在饭店工作也可能不值这个，北京的前端/后端平均工资我也是有过了解的。同学大都是这个工资（注意：这个同学可以向HR强调是平时一起讨论问题的同学，暗示水平差不多)；
2. 上几家都给我6千了，我没有去（觉得自己值多少钱，那就是值多少）；
3. 我不是乱要价，我有能力完成完成上级交代的任务，创造出超过7000元价值的能力（强调自己的能力）；
4. 对技术狂热，会沿着前端/后端道路一直往前走（强调自己对这份工作的热爱）；
...
- 对于前端/后端，我做过很多的项目，也有系统的学习过。并不比年纪大的人差。
